...
This repository contains the completely serverless backend for PantryPal V3, built entirely on AWS using Terraform and Node.js.
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/HarlieTran/pantrypal-dev.git pp-backend
   cd pp-backend
   ```
